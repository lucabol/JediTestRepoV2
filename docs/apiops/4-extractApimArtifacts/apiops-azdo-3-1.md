...
2. Create a new pipeline based on [**run-extractor.yaml**]([source repository link]) in your repository. Always refer to the specific run-extractor.yaml file that you downloaded as part of your release and not the one hosted on the repo.
