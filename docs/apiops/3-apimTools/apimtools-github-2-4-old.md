...
<br />
The updated setup [can be found here](https://[source documentation link]).
...
2. Download the source code zipped folder for the release you are targeting. The list of releases can be found [here]([source repository link])
