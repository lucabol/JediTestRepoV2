...
<br />
The older setup [can be found here](https://[source documentation link]).
...
8. Thats it. You are now ready to extract and publish your Azure APIM instance artifacts. Refer to the extract and publish APIM artifacts sections for more information. For a list of supported artifacts refer to [this section ](https://[source documentation link]).
